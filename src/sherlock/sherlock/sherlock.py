...
from src.sherlock.sherlock.result import QueryResult
from src.sherlock.sherlock.notify import QueryNotifyQueue
from src.sherlock.sherlock.sites import SitesInformation
...
def main(result_queue):
    ...
    query_notify = QueryNotifyQueue(result_queue,
                                    result=None,
    ...
    for username in all_usernames:
        ...
        if args.xlsx:
            ...
            DataFrame = pd.DataFrame({"username": usernames, "name": names, "url_main": url_main, "url_user": url_user,
